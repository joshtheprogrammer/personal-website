...
const Contact = () => {
    ...
    return (
        <div id="contact" class="page">
             <a href='https://www.instagram.com/joshuahonguyen' target="_blank">
                Instagram <br/> <AiOutlineInstagram id="instagramicon"/>
            </a>
            <a href='https://www.linkedin.com/in/joshuahonguyen/' target="_blank">
                LinkedIn <br/> <AiFillLinkedin id="linkedinicon"/>
            </a>
            <a href='https://www.twitter.com/joshuahonguyen' target="_blank">
